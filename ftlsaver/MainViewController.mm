        ...
        case 2:
          ...
          if([self.saveNameText.text length] != 0) {
            ...
            [self.tableView reloadData];
              ...
              UIAlertController*theAlert = [UIAlertController alertControllerWithTitle:@"Alert!" message:@"You cannot save a file without first specifying a name!" preferredStyle:UIAlertControllerStyleAlert];
